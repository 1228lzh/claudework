  ...
  <div class="submit-form">
    ...
    <div class="step-content">
      ...
      <template v-if="currentStep === 0">
        <van-field v-model="form.wecomUserId" label="报备人工号" readonly class="readonly-field" required />
        <van-field v-model="form.reporterName" label="报备人姓名" readonly class="readonly-field" required />
        <van-field v-model="form.reporterDept" label="部门" placeholder="请输入部门" required />
        <van-field v-model="form.reporterContact" label="联系方式" placeholder="请输入联系方式" required />
      </template>
